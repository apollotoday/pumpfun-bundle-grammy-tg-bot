...
import { commitmentType, eventAuthority, pumpFunProgram, rentProgram, systemProgram } from "../../config/contant";
...
export class PumpFunSDK {
    ...
    async createAndBatchBuy(
        ...
        const mintAtaList = buyers.map(item => getAssociatedTokenAddressSync(mint.publicKey, item.publicKey))
        ...
        if (lutResult.Err) {
            ...
            return {
                success: false, error: 'creating lut table account error'
            }
        }
